...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, SidebarComponent, TopbarComponent, RightPanelComponent, AuthModalComponent, ProfileSetupModalComponent, LogoutConfirmComponent, DeleteConfirmComponent],
